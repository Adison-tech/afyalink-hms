...
exports.createAppointment = async (req, res) => {
  ...
  let { patient_id, doctor_id, appointment_date, appointment_time, reason, status } = req.body;
  ...
  try {
    ...
    const newAppointment = await pool.query(
      `INSERT INTO appointments (patient_id, doctor_id, appointment_date, appointment_time, reason, status)
       VALUES ($1, $2, $3, $4, $5, COALESCE($6, 'Scheduled')) RETURNING *`,
...
exports.updateAppointment = async (req, res) => {
  ...
  const { id } = req.params;
  let { patient_id, doctor_id, appointment_date, appointment_time, status, reason } = req.body;
