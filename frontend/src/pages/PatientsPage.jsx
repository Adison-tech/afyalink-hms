...
function PatientsPage() {
  ...
  if (authLoading) return (
    <div className='flex justify-center items-center h-screen bg-gray-100'>
      ...
      <div className='ml-3 text-xl text-gray-700'>Loading authentication...</div>
    </div>
  );
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        >
          <input
            ...
            className="w-full px-4 py-2 pl-10 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
          />
